      ...
      <div className='digits-background'>
        <Grid container centered stackable columns={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h3' inverted>This address book allows any number of users to register
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h3' inverted>Each time you make contact with a contact, you can write a note that summarize their conversation.
              This note is saved along with a timestamp and the contact.</Header>
          </Grid.Column>
